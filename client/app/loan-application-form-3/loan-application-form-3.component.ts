...
@Component({
  selector: 'loan-application-form-3',
  templateUrl: './loan-application-form-3.component.html',
  styleUrls: ['./loan-application-form-3.component.scss']
})
export class LoanApplicationForm3Component {
  ...
  nextPage() {
    this.router.navigate(['loan-application-form-4']);
